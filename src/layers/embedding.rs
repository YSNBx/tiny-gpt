...
impl Embedding {
	...
	pub fn apply_gradient(&mut self, d_embedding: &Tensor, context_indices: &[usize], learning_rate: f32) {
		for i in 0..context_indices.len() {
			let index_to_update = context_indices[i];
